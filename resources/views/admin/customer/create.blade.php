    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <a href="{{ route('superadmin.admin.index') }}" class="breadcrumb-item">Pelanggan</a>
                <span class="breadcrumb-item active">Tambah Pelanggan</span>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.customer.store') }}" method="POST">
                            ...
                            <div class="text-right">
                                <a href="{{ route('admin.customer.index') }}" class="btn btn-danger"><i
