				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Edit Pelanggan</span>
                        </div>
                    </div>
				</div>
			</div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" value="1" class="form-input-styled" name="gender" {{ $customer->gender == 1 ? 'checked':'' }} data-fouc>
                                    Laki-Laki
                                </label>
                            </div>
                            ...
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" value="0" class="form-input-styled" name="gender" {{ $customer->gender == 1 ? 'checked':'' }} data-fouc>
                                    Perempuan
                                </label>
                            </div>
                        </div>
