                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.product.update', [$product]) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Bahan:</label>
                                <input type="text" class="form-control" value="{{ $product->materials }}" name="materials">
                            </div>
                            @error('materials')
                            <div class="alert alert-warning alert-rounded alert-dismissible">
                                <button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
                            ...
                            <div class="form-group">
                                <label>Variasi:</label>
                                <input type="text" class="form-control" value="{{ $product->varian }}" name="varian">
                            </div>
                            @error('varian')
                            <div class="alert alert-warning alert-rounded alert-dismissible">
                                <button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
                            ...
                            <div class="text-right">
                                <a href="{{ route('admin.product.index') }}" class="btn btn-danger"><i
