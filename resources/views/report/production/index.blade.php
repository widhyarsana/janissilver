     ...
     <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
          <div class="d-flex">
               <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Laporan Produksi</span>
               </div>
...
<div class="content">
     ...
     <div class="card">
          <div class="card-header text-center">
               <h1 class="card-title">LAPORAN PRODUKSI</h1>
               <hr style="width: 150px; border: solid red 1px;" class="round">
          </div>

          <div class="card-body">
               <form action="{{ route('report.production.store') }}" method="post">
                    {{-- <form> --}}
                    @csrf
                    ...
                    <table class="table">
                         ...
                         <tbody>
                              ...
                              <tr>
                                   ...
                                   <td>{{ $production->order->code }} - <span class="text-muted">{{ $production->order->customer->name }}</span></td>
...
<script>
     function search() {
          ...
          $.ajax({
               url:"{{ route('report.production.store') }}",
               headers: {
